...
export default class ItemRequestScreen extends Component{
  ...
  addRequest =(itemName,reasonToTrade)=>{
    var userId = this.state.userId
    var randomRequestId = this.createUniqueId()
    db.collection('requested_items').add({
        "user_id": userId,
        "item_name":itemName,
        "reason_to_trade":reasonToTrade,
          ...
          <MyHeader title="Request Item" navigation ={this.props.navigation}/>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              <TextInput
                ...
                value ={this.state.reasonToReque}
              />
              <TouchableOpacity
                style={styles.button}
                onPress={()=>{this.addRequest(this.state.itemName,this.state.reasonToTrade)}}
                >
                <Text>Request</Text>
              </TouchableOpacity>
            </KeyboardAvoidingView>
